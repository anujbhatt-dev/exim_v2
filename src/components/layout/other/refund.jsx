...
class Refund extends Component{
  ...
  componentDidMount = () => {
    ...
    render(){
      ...
      return (
            <div className="terms">
                 <div className="heading-primary terms__heading">Refund Policy</div>
                 <div className=""></div>
                 <div className="terms__para">
                    <strong>Returns</strong><br/>
                    Our policy lasts 7 days. If 7 days have gone by since your purchase, unfortunately we can’t offer you a refund or exchange in Case of goods.<br/>
                    ...
                    <br/><span style={{marginLeft:"4rem"}}>Gift cards</span>
                    <br/><span style={{marginLeft:"4rem"}}>Downloadable software products</span>
                    <br/><span style={{marginLeft:"4rem"}}>Some health and personal care items</span><br/><br/>
                    ...
                    If you’ve done all of this and you still have not received your refund yet, please contact us at<br/>
                    <strong>hello@eximeducation.com.</strong><br/>
                    <br/>
                    ...
                    We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at <a href="mailto::hello@eximeducation.com.">hello@eximeducation.com.</a><br/>
                    <br/>
                    ...
                    To return your product, you should mail your product to: 406, Glitz mall, kalbadevi, mumbai 400002.
                    ...
                    <br/><strong>SERVICE REFUNDS</strong><br/><br/>

                    <strong>If you Buy any course or take services from us, refund will be given excluding transaction charges to you if you inform us about the refund prior to the start of lecture or before you take any service.</strong>
